...
const RegisterPage = () => {
  ...
  return (
    <div className='w-2/5 mx-auto h-screen flex flex-row items-center'>
      <div className=" border border-1 border-gray-400 flex flex-col gap-5 w-full p-10">
        ...
        <form className="flex flex-col gap-5">
          ...
          <div className="flex relative">
            ...
            <input type={passView === true ? 'password' : 'text'} id="website-admin" className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Password" />
          ...
          <div className="flex relative">
            ...
            <input type={confirmPassView === true ? 'password' : 'text'} id="website-admin" className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Confirm Password" />
            <span className="inline-flex items-center px-3 text-sm text-gray-900 absolute inset-y-0 right-0">
              {
                confirmPassView === true ?
                  <svg onClick={handleConfirmPassView} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                  </svg> :
                  <svg onClick={handleConfirmPassView} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
        ...
        <div className='flex flex-row justify-between items-center'>
          <h2>Have account ?</h2>
          <Link href="/authentication/login" className="border border-1 bg-blue-500 border-white text-xl w-fit text-white px-5 py-1 rounded-md">Go Login Page</Link>
        </div>
      </div>
    </div>
  )
