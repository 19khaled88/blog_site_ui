...
const MustReadPage = () => {
    return (
        <div className='p-10'>
            <span className='flex flex-row justify-between px-2 pb-5'>
            ...
            <div className='flex flex-row gap-5 '>
                <Link href="#" className='relative'>
                    ...
                    <div className='absolute bottom-5 pl-5 text-white flex flex-col gap-5 text-xs font-semibold'>
                        <h5>GADGET</h5>
                        <h1 className='text-2xl'>Spend a Dollar on Upcoming iPhone 13, and How to Save More</h1>
                ...
                <Link href="#" className='relative'>
                    ...
                    <div className='absolute bottom-5 pl-5 text-white flex flex-col gap-5 text-xs font-semibold'>
                        <h5>MUST READ</h5>
                        <h1 className='text-2xl'>No Longer a Dream: Silicon Valley Takes On the Flying Car</h1>
                        <p className='text-white text-lg'>Cursus iaculis etiam in In nullam donec sem sed consequat scelerisque nibh amet, massa egestas risus, gravida vel amet, imperdiet …</p>
                    </div>
                </Link>
            </div>
